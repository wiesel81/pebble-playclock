...
![alt text](docs/standby.png "STANDBY")
#### SELECT-Button
Vibration signals can be enabled / disabled immediately without connecting to the phone.

### 40" RUNNING
![alt text](docs/40_running.png "40sec RUNNING")
#### SELECT-Button pressed long
Stops 40" countdown (new state: *40" STOPPED*)

### 40" EXPIRED (*1x long vibe*)
![alt text](docs/40_expired.png "40sec EXPIRED")

### 40" STOPPED
![alt text](docs/40_stopped.png "40sec STOPPED")

### 40" PRESET
![alt text](docs/40_preset.png "40sec PRESET")
...
![alt text](docs/settings_global.png "global settings")
![alt text](docs/settings_buttons.png "button settings")
![alt text](docs/settings_notification1.png "notification settings")
![alt text](docs/settings_notification.png "notification settings")
